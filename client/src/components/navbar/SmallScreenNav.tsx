...
function BeforeAuth() {
    return (
        <ul className="flex flex-col space-y-2 items-center justify-center w-full">
            ...
            <a href="/signup" className="p-2 w-3/4 bg-greenc text-xl text-white rounded-xl flex justify-center items-center space-x-[4px]">
                <p >Get Started</p>
...
function AfterAuth() {
    return (
        <div className="flex flex-col space-y-2  items-center w-full">
            <a href="/history" className="flex p-2 space-x-[4px] text-gray-600 text-lg items-center">
