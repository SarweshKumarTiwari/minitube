...
function BeforeAuth() {
    return (
        <div className="flex items-center mr-4 space-x-[12px]">
            <a href="/signin" className="p-2 rounded-xl text-greenc border border-greenc hover:bg-greenc hover:text-white">
                Sign In
            </a>
            <a href="/signup" className="p-2 rounded-xl bg-greenc text-[#FFFFFF] transition delay-100 hover:scale-y-110 hover:scale-x-110">
                Get Started
            </a>
        </div>
    )
...
export default function BigScreenNav(props: { isUser: boolean,userName:string}) {
    const [dropdown, setdropdown] = useState(false)
    return (
        <div className=" max-md:hidden max-md:invisible sticky">
            <div className=" m-2 flex justify-between items-center max-h-full ">
                <div className="flex items-center space-x-[6px]">
                    <img src={logo1} alt="logo" width={50} height={50} />
                    <h2 className="text-2xl text-gray-800">MiniTube</h2>
                </div>
                <div className="w-full flex max-w-[25%] space-x-[12px] items-center" >
                    <div className=" flex p-2 rounded-2xl border border-gray-400 space-x-[8px] items-center">
                        ...
                        <input type="search" id="search" className="focus:outline-none border-none w-full" autoComplete="off" placeholder="Search videos" />
                    </div>
